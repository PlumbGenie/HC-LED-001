...
#define BME280_CS_LOW() do{LATDbits.LATD1 = 0;} while(0)
#define BME280_CS_HIGH() do{LATDbits.LATD1 = 1;} while(0)

//MSSP2
//#define BME280_SCK1_TRIS    TRISDbits.TRISD6
//#define BME280_SDI1_TRIS    TRISDbits.TRISD5
//#define BME280_SDO1_TRIS    TRISDbits.TRISD4
//#define BME280_CS_TRSIS     TRISEbits.TRISE2
//
//#define BME280_SPI_READ()   SPI2_ExchangeByte(0)
//#define BME280_SPI_WRITE(a) SPI2_ExchangeByte(a)
...
#define BME280_SPI_READ()   SPI1_ExchangeByte(0)
#define BME280_SPI_WRITE(a) SPI1_ExchangeByte(a)
