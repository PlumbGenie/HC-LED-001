...
#define WRITE_MEMORY_BLOCKSIZE    64
#define ERASE_MEMORY_BLOCKSIZE    1024
#define END_FLASH                131072
    ...
    /**
      ...
      @Example
        ...
        readByte = MEMORY_ReadByte(flashAddr);
        </code>
     */
    ...
    /**
      ...
      @Example
        ...
        readWord = MEMORY_ReadWord(flashAddr);
        </code>
     */
     ...
     *flashRdBufPtr - Pointer to RAM buffer of size 'ERASE_MEMORY_BLOCKSIZE' at least
     ...
     @Example
       ...
       uint32_t    flashAddr = 0x7D00;
       uint8_t    Buf[ERASE_MEMORY_BLOCKSIZE];

       MEMORY_WriteByte(flashAddr, Buf, writeData);
       </code>
     */
     ...
     *flashWrBufPtr - Pointer to an array of size 'WRITE_MEMORY_BLOCKSIZE' at least
      ...
      @Example
        <code>
        #define MEMORY_ROW_ADDRESS     0x7D00
        ...
        MEMORY_WriteBlock((uint32_t)MEMORY_ROW_ADDRESS, (uint8_t *)wrBlockData);
        </code>
     */
    ...
    /**
      ...
      @Example
        ...
        MEMORY_EraseBlock(flashBlockStartAddr);
        </code>
     */
